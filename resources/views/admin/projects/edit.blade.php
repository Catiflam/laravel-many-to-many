  ...
  <form method="POST" action="{{ route('admin.projects.update', $project) }}" class="row">
      ...
      <div class="row">
        <div class="col-8">
          ...
          <div class="col-4 position-relative">
            ...
            <span class="position absolute top-0 start-100 translate-middle badge-rounder-pill bg-danger delete-image-button">
    ...
    <div class="col-12 mb-4">
      <div class="form-check @error('technologies') is-invalid @enderror" >
        ...
        <div class="col-2">
          <input type="checkbox" name="technologies[]" id="technologies" value="{{$technology->id}}" class="form-check-control"@if(in_array($technology->id,old('technologies',$technology_ids)??[]))checked @endif>
